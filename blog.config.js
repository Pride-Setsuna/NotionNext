...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '信哲', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个热爱技术的小白', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xinzhe-ldgqkc3s1-xinzhe.vercel.app', // 网站地址
