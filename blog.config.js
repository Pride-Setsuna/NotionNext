...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://daily-toque-7dd.notion.site/bb9c41d4974947dc837e8f327ef5fe59?v=61b61934b2724ad99f292b282cf43b1d&pvs=4
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'bb9c41d4974947dc837e8f327ef5fe59',
  ...
  SINCE: 2023, // e.g if leave this empty, current year will be used.版权信息©️
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'こんにちは、私はプログラマーです,こんにちは、新たな技術が大好きですよ,理想があり、生活を愛しています,私のブログへようこそ！🎉',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '信哲', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'gao-yiqian@outlook.com', // 邮箱地址
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/Pride-Setsuna', // 你的GitHub个人主页
  ...
  COMMENT_GISCUS_LANG: process.env.NEXT_PUBLIC_COMMENT_GISCUS_LANG || 'zh-CN,ja-JP', // 你的 Giscus 語言 e.g 'en', 'zh-TW', 'zh-CN', 預設 'en'
